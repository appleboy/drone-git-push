...
A CI/CD plugin for [Drone](https://www.drone.io/), [Woodpecker](https://woodpecker-ci.org/), [GitHub Actions](https://github.com/features/actions), and [Gitea Actions](https://docs.gitea.com/usage/actions/overview) to push changes to a remote Git repository.
